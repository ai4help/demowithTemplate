...
import { Followersdata, Friendsdata, Gallerydata, Personalinfodata, RecentPostsdata, Skillsdata, Suggestionsdata } from '../../../shared/data/profiledata';
                                                ...
                                                <Tab.Pane className="fade p-0 border-0" id="posts-tab-pane" eventKey="second">
                                                    <ListGroup className="list-group">
                                                        ...
                                                        <ListGroup.Item id="profile-posts-scroll">
                                                            <PerfectScrollbar style={{ height: '580px' }}>
                                                                <Row className=" gy-3">
                                                                        ...
                                                                        <div className="rounded border">
                                                                            <div className="p-3 d-flex align-items-top flex-wrap">
                                                                                ...
                                                                                <div className="d-flex align-items-top">
                                                                                    ...
                                                                                    <Dropdown>
                                                                                        <Dropdown.Toggle className="btn btn-sm btn-icon btn-light btn-wave no-caret" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                            ...
                                                                            <div className="p-3 d-flex align-items-top flex-wrap">
                                                                                ...
                                                                                <div className="flex-fill">
                                                                                    ...
                                                                                    <p className="mb-3 profile-post-link">
                                                                                        <Link href="#!" className="fs-12 text-primary">
