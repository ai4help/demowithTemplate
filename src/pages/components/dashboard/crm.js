...
import { Candidatesdata, Candidatesdatas, Candidatesdatass, Conversionratio, Profit, Profitearned, Revenueanalytics, Totalcustomers, Totaldeals, Totalrevenue } from '../../../../shared/data/charts/dashboard'
import Link from "next/link";
import { Dealsstatistics } from '../../../../shared/data/dashboard/crmdata'
                                                    ...
                                                    <tr key={Math.random()} >
                                                        ...
                                                        <td>
                                                            <div className="hstack gap-2 fs-15">
                                                                <Link aria-label="anchor" href="#!" className="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-success-light"><i className="ri-download-2-line"></i></Link>
                                                                <Link aria-label="anchor" href="#!" className="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-primary-light"><i className="ri-edit-line"></i></Link>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))}
                                            ...
                                            <nav aria-label="Page navigation" className="pagination-style-4">
                                                <ul className="pagination mb-0">
                                                    ...
                                                    <li className="page-item">
                                                        <Link href="#!" className="page-link text-primary">
                                                            next
                                                        </Link>
                                                    </li>
                                                </ul>
                                ...
                                <Col xxl={12} xl={6}>
                                    <Card className=" custom-card">
                                        ...
                                        <Card.Body className=" overflow-hidden p-0">
                                            <div className="leads-source-chart d-flex align-items-center justify-content-center p-4">
                                                <Candidatesdatas />
                                                ...
                                                <ul className="list-unstyled mb-0 crm-recent-activity">
                                                    <li className="crm-recent-activity-content">
                                                        <div className="d-flex align-items-top">
                                                            ...
                                                            <div className="crm-timeline-content">
                                                                <span className="fw-semibold">Update of calendar events &amp;</span><span><Link href="#!" className="text-primary fw-semibold"> Added new events in next week.</Link></span>
                                                            </div>
                                                    ...
                                                    <li className="crm-recent-activity-content">
                                                        <div className="d-flex align-items-top">
                                                            ...
                                                            <div className="crm-timeline-content">
                                                                <span>Completed documentation of <Link href="#!" className="text-purple text-decoration-underline fw-semibold">AI Summit.</Link></span>
                                                            </div>
                                                            <div className="flex-fill text-end">
                                                                <span className="d-block text-muted fs-11 op-7">4 hrs</span>
                                                            </div>
