...
const Sidebar = ({ local_varaiable, ThemeChanger }) => {
	...
	function Onhover() {
		const theme = store.getState();
		if ((theme.toggled == "icon-overlay-close" || theme.dataVerticalStyle == "detached") && theme.iconOverlay != "open") {
										...
										{firstlayer.Items.map((secondlayer) =>
											secondlayer.type === "link" ?
												<li className={`slide ${secondlayer.active ? "active" : ""}`} key={Math.random()} >
													...
													<Link onClick={(event) => { setSidemenu(secondlayer); noChild(); }} href={secondlayer.path + "/"} className={`side-menu__item ${secondlayer.selected ? "active" : ""}`}>{secondlayer.icon} <span className="side-menu__label">{secondlayer.title} {secondlayer.badgetxt ? (
												...
												: secondlayer.type === "sub" ?
													<li className={`slide has-sub ${secondlayer.active ? "open" : ""}`} key={Math.random()} onClick={() => MenuOpen()}>
														<Link href="#!" className={`side-menu__item ${secondlayer.selected ? "active" : ""}`}
															...
															<i className="angle fe fe-chevron-right side-menu__angle"></i></Link>
														<ul
																		...
																		: thirdlayer.type === "sub" ? <li className={`slide has-sub ${secondlayer.active ? "open" : ""}`}>
																			<Link href="#!"
																				...
																				onClick={(evnt) => {
																					...
																					{thirdlayer.title}
																				</span><i className="fe fe-chevron-right side-menu__angle"></i></Link>
																			<ul className={`slide-menu child2 ${thirdlayer.active ? "active" : ""
																				}`} style={
                                          thirdlayer.active
                                            ? { display: "block" }
                                            : { display: "none" }
																				...
																				{thirdlayer.children.map((fourthlayer) => <React.Fragment key={Math.random()}>
																					{fourthlayer.type === "link" ?
																						...
																						: fourthlayer.type === "sub" ? <li className={`slide has-sub ${fourthlayer.active ? "open" : ""}`}>
																							...
																							<Link href="#!" className="side-menu__item" onClick={(evnt) => {
																								evnt.preventDefault();
																							...
																							<ul className={`slide-menu child3 ${fourthlayer.active ? "!block" : ""
																								...
																								{fourthlayer.children.map((fivthlayer) => <React.Fragment key={Math.random()}>
																									{fivthlayer.type === "link" ?
																										...
																										</li> : <Link href="#!" className="side-menu__item" onClick={(evnt) => {
																											evnt.preventDefault();
